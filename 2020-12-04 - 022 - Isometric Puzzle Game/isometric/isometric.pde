...
void setup() {
  ...
  String[] placeableTileNames = new String[] {
    "road_1", "road_2",
    "roadcorner_1", "roadcorner_2", "roadcorner_3", "roadcorner_4",
    "roadtee_1", "roadtee_2", "roadtee_3", "roadtee_4", "roadtee_5",
    "roadend_1", "roadend_2", "roadend_3", "roadend_4"
  ...
  currentLevel = library.levels.get(0);
}
...
void keyPressed() {
  if (key == CODED) {
    ...
    println("Valid: " + currentLevel.isValid());
    println("Connected: " + currentLevel.areBuildingsConnected());
  }
